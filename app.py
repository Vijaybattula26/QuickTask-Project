...
def index():
    ...
    return render_template('index.html', tasks=tasks, sort_by=sort_by, filter_status=filter_status, search_query=search_query)
...
# New route for editing a task via AJAX
